...
<table border="0" align="center" cellspacing="4">
  <tr>
	...
	<form action="" method="post" name="formDatos" id="formDatos" >
	  <table width="80%" border="0" align="center" class="borde_recuadro">
       <tr>
         <td colspan="3"><div align="center"><span class="titulo_noticia"><img src="imagenes/report_add.png" width="32" height="32" align="absmiddle" /></span><span class="titulo_noticia"> Asignar Legajo</span></div></td>
        </tr>
       ...
       <tr>
         ...
         <td colspan="2"><input name="Legajo" type="text" id="Legajo" class="required digits" /> 
           * 
             <button id="GenerarLegajoColegio" title="Genera un número de legajo" class="botones"><img src="imagenes/bg-checkbox-checked.gif" width="18" height="18" align="absmiddle" /> Generar legajo</button></tr>
       <tr>
       <tr>
	...
	<tr>
       ...
       <tr>
         ...
         <td colspan="2"><input type="checkbox" name="Leg_Baja" id="Leg_Baja" />       
        </tr>
       <tr>
