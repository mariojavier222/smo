	...
	function colocarValor(event, data, formatted) {
		if (data){
			...
			$.ajax({
				...
				error: function (XMLHttpRequest, textStatus){
					alert(textStatus);},
				data: {opcion: "buscarCursoDivisionActual", PerID: $("#PerID").val()},
				url: 'cargarOpciones.php',
				success: function(data){ 
					$("#textoCurso").val(data);
					//alert("no entre");
...
<form action="imprimirCertificado.php" method="post" target="_blank" class="cmxformNOOO" id="formDatos">
    <p>&nbsp;</p>
    <table width="95%" border="0" align="center" class="borde_recuadro">
        <tr>
            <td colspan="2">		
                <div align="center" class="titulo_noticia"><img src="imagenes/table.png" width="32" height="32" align="absmiddle" /> Imprimir Certificados</div></td>
        </tr>
        <tr>
        ...
        *       
        ...
        <tr>
          ...
          <table width="100%" border="0" cellspacing="1" cellpadding="1">
            ...
            <tr class="texto">
              <td align="right">Título del Certificado:</td>
              <td><input name="textoTitulo" type="text" required id="textoTitulo" value="CERTIFICADO DE ESCOLARIDAD" size="50" /></td>
            </tr>
            <tr class="texto">
            ...
            <tr class="texto">
              <td align="right">Texto Habiendo:</td>
              <td><input name="textoHabiendo" type="text" id="textoHabiendo" value="finalizado" size="50" required /></td>
            </tr>
            <tr class="texto">
              <td align="right">Ciclo Lectivo Finalizado:</td>
              <td><input name="textoLectivo" type="text" id="textoLectivo" value="<?php echo intval(date("Y"));?>" size="50" required /></td>
            </tr>
            <tr class="texto">
              <td align="right">Línea adicional: </td>
              <td><textarea name="textoLineaAdicional" id="textoLineaAdicional" cols="45" rows="5"></textarea></td>
            </tr>
            <tr class="texto">
              <td align="right">Para presentar ante:</td>
              <td><input name="textoQuien" type="text" id="textoQuien" value="quien corresponda" size="50" required /></td>
            </tr>
            <tr class="texto">
              <td colspan="2" align="center"><button class="botones" id="barraMostrar">Imprimir Certificado</button></td>
            </tr>
            <!--<tr>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
