	...
	$("#barraMostrar").click(function(evento){
		...
		if (validarDatos()){
			...
			$.ajax({
				...
				Correo: vCorreo, Tel: vTel, Cel: vCel},
...
<div id="mostrarCuotas">
	...
	<table width="95%" border="0" align="center" class="borde_recuadro">
      <tr>
        <td colspan="2">		
		<div align="center" class="titulo_noticia"><img src="imagenes/group_go.png" width="32" height="32" align="absmiddle" /> Listar Datos Personales de los Alumnos de Postgrado</div></td>
      </tr>
	   <tr>
...
<br />
      ...
      <label for="Cel">Celular</label></tr>
      <tr>
