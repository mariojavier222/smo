		...
		if (validarDatos()){
			...
			$.ajax({
				...
				error: function (XMLHttpRequest, textStatus){
					alert(textStatus);},
				data: {fechaDesde: vFechaDesde, fechaHasta: vFechaHasta, NivID: vNivID, CTi_ID: vCTi_ID},
				url: 'mostrarPercibidosNivel.php',
	...
	<table width="95%" border="0" align="center" class="borde_recuadro">
      <tr>
		...
		<div align="center" class="titulo_noticia">
		  <p><img src="imagenes/table_key.png" width="32" height="32" align="absmiddle" /> Listar Percibidos por Nivel
	      </p>
        </div></td>
      </tr>
       <tr>
