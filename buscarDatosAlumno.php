...
//$sqlJOIN = "AND Per_ID IN (SELECT Per_ID FROM Legajo INNER JOIN Persona ON (Leg_Per_ID = Per_ID) INNER JOIN Colegio_Inscripcion ON (Ins_Leg_ID = Leg_ID))";

$sql = "SELECT * FROM Persona INNER JOIN Legajo ON (Per_ID = Leg_Per_ID) $sqlWhere  ORDER BY Per_Apellido, Per_Nombre";
