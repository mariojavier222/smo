...
/*	$div = $row[Div_Nombre];
	...
	?>
	<tr class="gradeA" id="fila<?php echo $i;?>" >
      ...
      <a href="#" onclick="buscarCuotasImpagas2('<?php echo $PerID ?>')" style="cursor:pointer; color:#000; font-style:normal; text-decoration: none;"><?php echo $textoDeuda; ?></a></td>
    </tr>
