...
if (!empty($DNI)){
	...
	?>
		<br /><div class="borde_alerta" align="center"><p class="texto"><img src="botones/Warning.png" alt="Advertencia" width="24" height="24" align="absbottom" />Al d�a de la fecha <?php echo $fechaHoy;?> el alumno <strong><?php echo "$usuario_nombre $usuario_apellido";?></strong> tiene una deuda vencida de $<?php echo $Deuda;?>.</p></div><br />
	<?php
	}else{
	...
	INNER JOIN Producto          ON (Chequera_Cuota.ChC_Pro_ID = Producto.Pro_ID) 		WHERE (Chequera_Serie.ChS_Per_ID = $DNI AND Chequera_Cuota.ChC_Pagado = 0     AND Chequera_Cuota.ChC_Baja = 0     AND Chequera_Cuota.ChC_Cancelado = 0) 	ORDER BY Chequera_Cuota.ChC_1er_Vencimiento ASC;";
}else{
	exit;}
...
<img src="imagenes/flechita_arriba.png" alt="Marcar/Desmarcar todo" width="38" height="22" border="0" align="absmiddle"/> <a href="#" id="marcar">Marcar</a> / <a href="#" id="desmarcar">Desmarcar todo</a> - <a href="#" id="imprimirTodas"><img src="imagenes/printer.png" alt="Imprimir las cuotas seleccionadas" title="Imprimir las cuotas seleccionadas" width="32" border="0" align="absmiddle" /></a> - <?php echo "Se econtraron $total cuotas sin pagar";?></div>
