...
while ($row = mysqli_fetch_array($result)){		
	...
	$pdf->ezText("\nD.N.I. Nº: <b>$row[Per_DNI]</b>                       EDAD: <b>".obtenerEdad($row['Per_ID'], $fechaNac)." años</b>", $fontSize, array('justification'=>'left'));

	$Curso = "$row[Cur_Nombre] $row[Div_Nombre]";
	$Nivel = $row['Niv_Nombre'];

	$pdf->ezText("\nCURSO Y DIVISIÓN: <b>".$Curso."</b>                       NIVEL: <b>$Nivel</b>", $fontSize, array('justification'=>'left'));
