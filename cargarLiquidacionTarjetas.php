...
$(document).ready(function(){
	...
	vTexto_Error = '';
		...
		if (validarDatos()){
			...
			$.ajax({
				...
				url: 'mostrarLiquidacionTarjetas.php',
	...
	$("#barraMostrarTotales").click(function(evento){
		...
		if (validarDatos()){
			...
			$.ajax({
				...
				error: function (XMLHttpRequest, textStatus){
					alert(textStatus);},
				data: {fechaDesde: vFechaDesde, fechaHasta: vFechaHasta},
				url: 'mostrarLiquidacionTarjetasAgrupadas.php',
				success: function(data){ 
					$("#mostrar").html(data);
				}
			});//fin ajax//*/
	...
	<table width="95%" border="0" align="center" class="borde_recuadro">
      <tr>
		...
		<div align="center" class="titulo_noticia">
		  <p><img src="imagenes/table_key.png" width="32" height="32" align="absmiddle" /> Liquidación de Tarjetas</p>
        </div></td>
      </tr>
      ...
      <tr>
        ...
        Buscar Recibos</button> <button class="botones" id="barraMostrarTotales">
        Buscar Agrupados</button>        
        </td>
      </tr>
      <tr>
