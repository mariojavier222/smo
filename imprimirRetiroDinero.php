...
$total = $i;
	...
	$pdf->ezSetY(800);
	$pdf->ezText("<b>COMPROBANTE DE CAJA</b>", $fontSize, array('justification'=>'center'));
	$fontSize = 12;
	$pdf->ezText(utf8_decode("\nEn San Juan, <b>$Fecha</b> siendo las <b>$Hora</b>, he retirado de la <b>Caja Nº $SCC_Caja_ID</b> perteneciente al Usuario <b>$Usuario</b>, la suma de <b>$".$SCC_Credito."</b> en <b>$FormaPago</b> en concepto de <b>$SCC_Concepto</b>.\n"), $fontSize, array('justification'=>'full'));		
	$fontSize = 10;
	$pdf->rectangle(25,$yArriba,550,150);
	$pdf->ezText("\n\n\n----------------------------------\n<b>$SCC_Detalle</b>   ", $fontSize, array('justification'=>'right'));	
		//$pdf->ezSetY(600);
		$fontSize = 12;
