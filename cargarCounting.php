	...
	$("#barraBuscar").click(function(evento){
		...
		$.ajax({
				...
				error: function (XMLHttpRequest, textStatus){
					alert(textStatus);},
				data: {opcion: "buscar<?php echo $Tabla;?>", Texto: "todos", Cou_Lec_ID: $("#Cou_Lec_ID").val()},
				url: 'cargarOpciones.php',
				success: function(data){ 
					//alert(data);
	...
	$("#textoBuscar").keyup(function(event){
		...
		if (event.keyCode == 13 || vTexto.length>2) {  
			...
			$.ajax({
				...
				error: function (XMLHttpRequest, textStatus){
					alert(textStatus);},
				data: {opcion: "buscar<?php echo $Tabla;?>", Texto: vTexto, Cou_Lec_ID: $("#Cou_Lec_ID").val() },
				url: 'cargarOpciones.php',
				success: function(data){ 
					//alert(data);
					$("#mostrarResultado").html(data);
...
<table border="0" align="center" cellspacing="4">
	...
	<table width="80%" border="0" align="center" class="borde_recuadro">
      ...
      <tr>
        <td colspan="2" valign="middle"><div align="center" class="titulo_noticia"><img src="imagenes/group.png" alt="Paises" width="32" height="32" align="absmiddle" /> Cargar Cantidad de Vacantes de un Curso/Turno</div></td>
      </tr>
          <tr>
            <td class="texto" align="right">Ciclo Lectivo:</td>
            <td align="left"><?php 
			$UniID = $_SESSION['sesion_UniID'];
			cargarListaLectivo("Cou_Lec_ID", $UniID);?><input name="opcion" type="hidden" id="opcion" value="guardar<?php echo $Tabla;?>" /></td>
        </tr>
          <tr>
	  <td class="texto" align="right">Curso:</td>
          <td align="left"><?php cargarListaCursosCompleto("Cou_Cur_ID");?></td>
        </tr>
          <tr>
            <td class="texto" align="right">Vacantes</td>
            <td align="left"><input type="text" name="Cou_Total" id="Cou_Total"></td>
          </tr>          
	...
	<div id="divBuscador">
       ...
       <table width="98%" border="0" align="center" class="borde_recuadro">
          <tr>
            <td><div align="center" class="titulo_noticia"><img src="iconos/mod_datos_personales.png" width="32" height="32" align="absmiddle" /> Listado de Vacantes por Curso/Turno</div></td>
          </tr>
          <tr>
