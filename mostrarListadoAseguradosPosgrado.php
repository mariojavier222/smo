...
/*	$div = $row[Div_Nombre];
	...
	<tr class="gradeA" id="fila<?php echo $i;?>" height="40px">
      ...
      <?php if ($Correo){?><td align="center"><?php if (!empty($rowDatos[Dat_Email])) echo $rowDatos[Dat_Email]; else echo "No está cargado";?></td><?php }?>
	...
	<tr class="gradeA" id="fila<?php echo $i;?>" height="40px">
      ...
      <?php if ($Cel){?><td align="center">---</td><?php }?>
		  ...
		  <?php	
		}//fin de que encontró otros datos en la búsqueda
