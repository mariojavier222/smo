...
<script language="javascript">
    $(document).ready(function(){
        ...
        $("#barraInscripcion").click(function(evento){
            ...
            //alert(vDNI.length);
            if (vDNI.length==0){
                mostrarAlerta("Antes de Inscribir debe seleccionar un alumno","Atenci�n");
            }else{
                $.ajax({
                    type: "POST",
                    cache: false,
...
<div id="mostrarNuevo">
    ...
    <form action="guardarLegajo.php" method="post" name="form_nuevo" id="form_nuevo" >
        <table width="80%" border="0" align="center" class="borde_recuadro">
            <tr>
                <td colspan="3"><div align="center"><span class="titulo_noticia"><img src="imagenes/report_add.png" width="32" height="32" align="absmiddle" /></span><span class="titulo_noticia"> Buscar Persona</span></div></td>
            </tr>
