		...
		if (validarDatos()){
			$.ajax({
				...
				error: function (XMLHttpRequest, textStatus){
					alert(textStatus);},
				data: {LecID: vLecID, CurID: vCurID, TitID: vTitID, MatID: vMatID, DivID: vDivID, SedID: vSedID, mostrarDeuda: false},
				url: 'mostrarListadoInscriptosLectivoTerciario.php',
...
<div id="mostrarCuotas">
	...
	<table width="95%" border="0" align="center" class="borde_recuadro">
      ...
      <tr>
         <td align="right" class="texto">Materia:</td>
         <td>   <select name="MatID" id="MatID">
           <option value="-1">Seleccione un T&iacute;tulo</option>
         </select>    </td>
      </tr>
      <tr>
