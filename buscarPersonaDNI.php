...
$DNI = $_POST['DNI2'];
$LecID = $_POST['LecID'];
$sql = "SELECT DISTINCTROW * FROM Persona WHERE Per_DNI like '$DNI%' ORDER BY Per_DNI,Per_Apellido, Per_Nombre";
$sql="SELECT DISTINCTROW * FROM Persona
    INNER JOIN Aspirante 
        ON (Persona.Per_ID = Aspirante.Asp_Per_ID)
        WHERE Per_DNI like '$DNI%' AND Asp_Lec_ID = $LecID ORDER BY Per_Apellido, Per_Nombre";
...
<?php
	...
	echo "No se encontraron personas asociadas a la b�squeda";
}
?>
