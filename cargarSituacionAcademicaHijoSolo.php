...
WHERE Familia.Fam_FTi_ID =1 AND P.Per_DNI = '$DNI' AND Fam_Per_ID = $PerIDHijo ";
...
<a href="#" id="imprimirTodas"><img src="imagenes/printer.png" alt="Imprimir las cuotas seleccionadas" title="Imprimir las cuotas seleccionadas" width="32" border="0" align="absmiddle" /></a> - <?php echo "Se econtraron $i clases";?></div>
