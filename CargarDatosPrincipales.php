...
//*/
	...
	$("#form_nueva2 #DNI").blur(function() {
		...
		if (iDNI.length>8 || iDNI.length<7)
			mostrarAlerta("Ha ingresado un número de documento superior a <strong>8 dígitos o menor a 7</strong>. Por favor verifique el número. Igual puede continuar", "Atención");
	});
...
<link href="css/general.css" rel="stylesheet" type="text/css" />
	...
	<table width="80%" border="0" align="center" class="borde_recuadro">
      ...
      <tr>
        ...
        <label class="error_buscador" for="DNI2" id="dni_error">* Por favor completar con un número de documento.</label></td>
      </tr>
      <tr>
	...
	<form action="PersonaNueva.php" method="post" enctype="multipart/form-data" name="form_nueva2" id="form_nueva2" autocomplete="off">
	  <table width="80%" border="0" align="center" class="borde_recuadro">
        <tr>
          <td colspan="2"><div align="center" class="titulo_noticia"><img src="imagenes/hombre-mujer.png" width="32" height="32" align="absmiddle" />Crear una persona </div></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input name="DNI" type="text" id="DNI" class="required digits" />
