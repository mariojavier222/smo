...
session_start();
	...
	INNER JOIN Colegio_Nivel
		...
		WHERE (Per_ID = $PerID AND Leg_Baja = 0) ORDER BY Lec_Nombre, Cur_Nombre, Div_Nombre, Mat_Nombre";
...
<div align="left" class="titulo_noticia">
  <p><a name="arriba" id="arriba"></a><img src="imagenes/font_add.png" width="32" height="32" align="absmiddle" /> Calificaciones de <?php echo $_POST['Persona'];?></p>  
</div>
<div id="listado" >	
