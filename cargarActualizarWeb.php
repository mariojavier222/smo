...
if ($_SERVER['SERVER_NAME']=="localhost" || $_SERVER['SERVER_NAME']=="servidor"){
	echo "NO SE PUEDE ACCEDER A ESTA OPCIÓN DESDE EL SERVIDOR LOCAL"; //*/
	//exit;
}
...
<div id="mostrarCuotas">
    ...
    <table width="95%" border="0" align="center" class="borde_recuadro">
        <tr>
            <td width="50">		
                <div align="center" class="titulo_noticia"><img src="iconos/browser_window_settings_32.png" width="32" height="32" align="absmiddle" /> Actualizar la WEB</div></td>
        </tr>
	...
	<script type="text/javascript">
		...
		$(function() {
			$('#file_upload').uploadify({
				...
				'uploader' : 'uploadify/subirActualizarWeb.php',
