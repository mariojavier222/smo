...
FROM
    ...
    INNER JOIN Persona 
        ON (LibroVenta.LVe_Per_ID = Per_ID)
    INNER JOIN Curso 
...
<h2>Libros vendidos por persona</h2>
 ...
 <table width="100%" border="0" id="listadoTabla" class="display">
    <thead>
        <tr>
          ...
          <th align="center" class="fila_titulo">Editorial</th>
        </tr>
       </thead>
       <tbody>
	<?php $i=0;
/*	$div = $row[Div_Nombre];
	...
	<tr class="gradeA" id="fila<?php echo $i;?>" height="40px">
      ...
      <td align="center"><?php echo $row[Lib_Editorial];?></td>
      </tr>
