...
$sql = "SELECT * FROM CajaCorriente
	...
	WHERE (CCC_Fecha >= '".cambiaf_a_mysql($fechaDesde)."' AND CCC_Fecha<='".cambiaf_a_mysql($fechaHasta)."' AND CCC_For_ID = 2 AND CCC_Credito<>0) ORDER BY CCC_Fecha";
 ...
 <table width="100px" border="0" id="listadoTabla" class="display">
    <thead>
        <tr>
          ...
          <th align="center" class="fila_titulo">Num Cheque</th>
          <th align="center" class="fila_titulo">Banco</th>
          <th align="center" class="fila_titulo">Fecha Emisión</th>
          <th align="center" class="fila_titulo">Fecha Cobro</th>
          <th align="center" class="fila_titulo">Firmante</th>
	   ...
	   //global $gMes;
		...
		?>
				<tr class="gradeA" height="25px">
				  ...
				  <?php buscarDatosPagoCheque($row['CCC_Referencia'], $arreglo);
				  echo "<td>".$arreglo['Num Cheque']."</td>";
				  echo "<td>".$arreglo['Banco']."</td>";
				  echo "<td>".$arreglo['Fecha Emisión']."</td>";
				  echo "<td>".$arreglo['Fecha Cobro']."</td>";
				  echo "<td>".$arreglo['Firmante']."</td>";
				  ?>
