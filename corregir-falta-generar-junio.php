...
function guardarAsignacionCuotaFaltante($Cuo_Per_ID, $Cuo_Lec_ID, $Cuo_Niv_ID, $CTi_ID, $mes, $anio, $numero) {
	...
	$sql = "SELECT * FROM CuotaPersona WHERE 
	...
	if (mysqli_num_rows($result_verif)==0){
		...
		values($Cuo_Per_ID, $Cuo_Niv_ID, $CTi_ID, $Cuo_Lec_ID, 1, '$numero', 1, '$UsuID', '$Fecha', '$Hora', '$Importe', '$Recargo1', '0.00', '$Vto1', '$Vto2', '$Vto3', $mes, $anio, '0','0','0', '$RecargoMensual', '$Importe', '', '0')";
		echo "$sql<br>";
		consulta_mysql_2022($sql,basename(__FILE__),__LINE__);
		
		obtenerBeneficioAlumnoNuevo($Cuo_Lec_ID, $Cuo_Per_ID, $CTi_ID, $Cuo_Ben_ID);
