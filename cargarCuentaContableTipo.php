...
$(document).ready(function(){
	...
	$("#CuT_Nombre").keyup(function(event){
...
<table border="0" align="center" cellspacing="4">
	...
	<table width="80%" border="0" align="center" class="borde_recuadro">
      ...
      <tr>
        <td colspan="2" valign="middle"><div align="center" class="titulo_noticia"> Cargar Tipos de Cuenta Contable</div></td>
      </tr>
          <tr>
            <td class="texto" align="right">Código:</td>
            <td align="left"><input name="CuT_ID" type="text" id="CuT_ID" size="10" readonly="readonly"> <i>(No completar)</i>
            <input name="opcion" type="hidden" id="opcion" value="guardar<?php echo $Tabla;?>" /></td>
        </tr>
          <tr>
	  <td class="texto" align="right">Nombre del Tipo de Cuenta Contable:</td>
          <td align="left"><input name="CuT_Nombre" type="text" id="CuT_Nombre" size="40"></td>
        </tr>
        <tr>
	  <td class="texto" align="right">Orden para mostrar:</td>
          <td align="left"><input name="CuT_Orden" type="text" id="CuT_Orden" size="10"></td>
        </tr>
        <tr>
	  <td class="texto" align="right">Categoría Padre:</td>
          <td align="left"><?php cargarListaCuentaTipo("CuT_Padre_ID", "nombre");?></td>
        </tr> 
	...
	<div id="divBuscador">
       ...
       <table width="98%" border="0" align="center" class="borde_recuadro">
          <tr>
            <td><div align="center" class="titulo_noticia"> Listado de Tipos de Cuenta Contables</div></td>
          </tr>
          <tr>
