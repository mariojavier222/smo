...
require_once("funciones_generales.php");
	...
	$DivID = $_GET['DivID'];
	$SedID = $_GET['SedID'];
	$textoAdicional = $_GET['textoAdicional'];
...
$Deuda = Obtener_Deuda_Sistema($row['Per_ID'], $Recargo);
if ($Deuda>0){	
	...
	$texto = "<b>Estimados Padres</b> $hijoArticulo $hijoTitulo <b>$PPa_Alumno</b> de <b>$Curso de $Nivel</b>.\n$textoAdicional\nLe pedimos que controle la situación económica de su hij$hijoVocal, que al día de la fecha, <b>$dia de $mes de $anio</b>, posee impagas y vencidas las siguientes cuotas según se detallan:\n";
	...
	$pdf->ezText($texto, $fontSize, array('justification'=>'full'));
	$texto = "<b><i>LA ADMINISTRACIÓN</i> - ".utf8_decode(COLEGIO_NOMBRE)."</b>\nHorario de atención: Lun a Vie de 08 a 16 hs.";
