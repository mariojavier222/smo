...
(function($) {
  ...
  var buttons = {
    bold:           [0, "Negrita", "bold"],
    italic:         [1, "Cursiva", "italic"],
    underline:      [2, "Subrayado", "underline"],
    strikethrough:  [3, "Strikethrough", "strikethrough"],
    subscript:      [4, "Subíndice", "subscript"],
    superscript:    [5, "Superíndice", "superscript"],
    font:           [6, "Fuente", "fontname"],
    size:           [7, "Tamaño de la Fuente", "fontsize"],
    style:          [8, "Estilo", "formatblock"],
    color:          [9, "Color de la fuente", "forecolor"],
    highlight:      [10, "Resaltado", "hilitecolor"],
    removeformat:   [11, "Remover Formato", "removeformat"],
    bullets:        [12, "Viñetas", "insertunorderedlist"],
    numbering:      [13, "Numeración", "insertorderedlist"],
    outdent:        [14, "Reducir sangría", "outdent"],
    indent:         [15, "Aumentar sangría", "indent"],
    alignleft:      [16, "Alinear a la izquierda", "justifyleft"],
    center:         [17, "Alinear al centro", "justifycenter"],
    alignright:     [18, "Alinear a la derecha", "justifyright"],
    justify:        [19, "Justificar", "justifyfull"],
    undo:           [20, "Deshacer", "undo"],
    redo:           [21, "Rehacer", "redo"],
    rule:           [22, "Insertar regla horizontal", "inserthorizontalrule"],
    image:          [23, 'Insertar Imagen', 'insertimage'],
    link:           [24, 'Insertar vínculo', 'createlink'],
    unlink:         [25, 'Remover vínculo', 'unlink'],
    cut:            [26, "Cortar", "cut", 1],
    copy:           [27, "Copiar", "copy", 1],
    paste:          [28, "Pegar", "paste", 1],
    print:          [29, "Imprimir", "print"],
    html:           [30, "Mostrar HTML"]
  };
