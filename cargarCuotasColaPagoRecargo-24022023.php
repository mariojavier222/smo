...
<?php	
	...
	<tr class="<?php echo $clase?>" id="filaCola<?php echo $i;?>" height="40px">
      ...
      <input type="hidden" id="importeCuota<?php echo $i;?>" value="<?php echo $recargo2;?>">
      <?php echo $i;?></td>
      <td><strong><?php echo "Gastos por tarjetas";?></strong></td>
       <td><strong><?php echo "Gastos administrativos";?></strong><?php //echo " ".$detalle_alternativa;?></td> 
      
      <td><?php echo buscarMes($mes);?></td>
      <td><?php echo $anio;?> </td>
      <td><?php echo $fechaCuota;?></td>
      <td></td>
      <td>$ <input type="hidden" id="importeAbonar<?php echo $i;?>" name="importeAbonar<?php echo $i;?>" value="0" size="7" maxlength="7"  />
	<input type="text" id="gastosAbonar<?php echo $i;?>" name="gastosAbonar<?php echo $i;?>" value="0" size="7" maxlength="7" style="vertical-align: middle;" />
      <a style="cursor:pointer" id="eliminarFila<?php echo $i;?>"> <img src="imagenes/bullet_delete.png" width="32" height="32" alt="Eliminar gastos administrativos" title="Eliminar gastos administrativos" border="0" style="vertical-align: middle;"/></a></td>
    </tr>
    <?php */?>
</table>
</div>
