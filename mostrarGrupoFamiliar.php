...
//sleep(3);
	...
	$sql = "SELECT * FROM Persona WHERE Per_Apellido LIKE '$Apellido%' ORDER BY Per_Apellido, Per_Nombre;";
 ...
 <table width="100%" border="0" id="listadoTabla" class="display">
    <thead>
        <tr>
          ...
          <th align="center" class="fila_titulo">Familia</th>
        </tr>
       </thead>
       <tbody>
	<?php $i=0;
...
<div align="left">
<a href="#" id="imprimirTodas"><img src="imagenes/printer.png" alt="Imprimir el listado" title="Imprimir el listado" width="32" border="0" align="absmiddle" /></a> - <a href="#" id="barraExportar"><img src="imagenes/icono_excel.gif" width="32" height="32" align="absmiddle"   border="0"/></a> - <?php echo "Se encontraron $total personas con que comienza con el apellido $Apellido.";?></div>
<br /><br /></fieldset>
...
?>
	<div class="borde_alerta"><span class="texto"><img src="botones/Warning.png" alt="Advertencia" width="24" height="24" align="absbottom" />No se encontraron personas con ese apellido.</span>
<?php
}
